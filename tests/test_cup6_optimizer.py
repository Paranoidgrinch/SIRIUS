...
def test_run_primary_rcds_orchestrates_components(
    ...
    # --------------------------------------------------------
    # RCDS construction and execution.
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # Completed trace must be persisted before the fresh
    # best-point confirmation, matching the established
    # Cup-2/Cup-4 production pattern.
    # --------------------------------------------------------
